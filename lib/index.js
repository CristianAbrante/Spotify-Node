...
function getArtistAlbums(artistName) {
  ...
  let data;
  synchronizePromise(function* () {
    data = yield SpotifyGetter.getArtistAlbums(artistName);
  });
  while(data === undefined) {
    Sync.sleep(SLEEP_TIME);
  }
...
module.exports = {getAlbumInfo, logAlbumInfo, getAlbumTracks, logAlbumTracks, getArtistAlbums, logArtistAlbums};